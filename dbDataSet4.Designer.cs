...
namespace WindowsFormsApplication1 {
    ...
    public partial class dbDataSet4 : global::System.Data.DataSet {
        ...
        public partial class loginDataTable : global::System.Data.TypedTableBase<loginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public loginRow AddloginRow(string id, string sname) {
            ...
            public string sname {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'login\' 테이블의 \'sname\' 열의 값이 DBNull입니다.", e);
                    }
                }
                set {
...
namespace WindowsFormsApplication1.dbDataSet4TableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `login` WHERE ((`id` = ?) AND ((? = 1 AND `sname` IS NULL) OR (`sname" +
                "` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `login` (`id`, `sname`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `login` SET `id` = ?, `sname` = ? WHERE ((`id` = ?) AND ((? = 1 AND `sname" +
                "` IS NULL) OR (`sname` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication1.Properties.Settings.Default.dbConnectionString6;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, sname FROM login";
        ...
        public virtual int Delete(string Original_id, string Original_sname) {
            if ((Original_id == null)) {
        ...
        public virtual int Insert(string id, string sname) {
            if ((id == null)) {
        ...
        public virtual int Update(string id, string sname, string Original_id, string Original_sname) {
            if ((id == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string sname, string Original_id, string Original_sname) {
            return this.Update(Original_id, sname, Original_id, Original_sname);
        }
    }
